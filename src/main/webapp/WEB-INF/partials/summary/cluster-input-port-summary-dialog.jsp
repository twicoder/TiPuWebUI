...
<div id="cluster-input-port-summary-dialog" class="hidden large-dialog">
    ...
    <button id="cluster-input-port-refresh-button" class="refresh-button pointer fa fa-refresh" title="刷新"></button>
    <div id="cluster-input-port-summary-last-refreshed-container" class="last-refreshed-container">
        最近一次更新：&nbsp;<span id="cluster-input-port-summary-last-refreshed" class="value-color"></span>
    </div>
